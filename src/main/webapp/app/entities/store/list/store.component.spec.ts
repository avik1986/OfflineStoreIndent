...
describe('Store Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '1d725fc9-527e-43ab-bb61-c31c85115fca' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '9cf1d135-42dd-4c1a-a97a-5619d2716dee' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.stores()[0]).toEqual(expect.objectContaining({ id: '1d725fc9-527e-43ab-bb61-c31c85115fca' }));
  });
