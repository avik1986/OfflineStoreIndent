...
export class StoreComponent implements OnInit {
  ...
  trackId = (item: IStore): string => this.storeService.getStoreIdentifier(item);
      ...
      .pipe(
        ...
        tap(() => {
          if (this.stores().length === 0) {
            ...
            this.stores.set(this.refineData(this.stores()));
          }
        }),
      )
      .subscribe();
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.stores.set(this.refineData(dataFromBody));
  }
