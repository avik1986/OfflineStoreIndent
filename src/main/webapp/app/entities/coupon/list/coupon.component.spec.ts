...
import { sampleWithRequiredData } from '../coupon.test-samples';
...
describe('Coupon Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'de4780a6-f7e3-45ad-87ba-b73185cef3d2' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'd2da5bdf-05f9-480b-ba8c-82307bde9d7c' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.coupons()[0]).toEqual(expect.objectContaining({ id: 'de4780a6-f7e3-45ad-87ba-b73185cef3d2' }));
  });
