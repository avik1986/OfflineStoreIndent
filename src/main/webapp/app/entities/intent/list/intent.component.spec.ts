...
import { sampleWithRequiredData } from '../intent.test-samples';
...
describe('Intent Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '874671f8-75b6-4a01-aa2e-c8f15cd4a2eb' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'dca0c813-d513-4d32-9a80-30cd3b3f8365' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.intents()[0]).toEqual(expect.objectContaining({ id: '874671f8-75b6-4a01-aa2e-c8f15cd4a2eb' }));
  });

  describe('trackId', () => {
    it('should forward to intentService', () => {
      const entity = { id: '874671f8-75b6-4a01-aa2e-c8f15cd4a2eb' };
