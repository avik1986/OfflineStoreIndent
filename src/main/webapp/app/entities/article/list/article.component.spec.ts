...
import { sampleWithRequiredData } from '../article.test-samples';
...
describe('Article Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'be05381e-70bd-46bf-98c6-db6a9c69d1fe' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '95abd217-e9fb-4450-a898-e65e44a7cbba' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.articles()[0]).toEqual(expect.objectContaining({ id: 'be05381e-70bd-46bf-98c6-db6a9c69d1fe' }));
  });
